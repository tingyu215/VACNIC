#!/bin/sh
CUDA_VISIBLE_DEVICES=2,3 torchrun --nproc_per_node=2 --master_port 29501 /CODEDIR/run_train_mmbart_enc_self_face_name_ids_retrieve_crossattn.py --seed 684331 \
...
--dim_common 768 \
--warmup_rate 0.05 --train_batch_size 16 --val_batch_size 1 --test_batch_size 1 \
